...
---
background-image: url(https://upload.wikimedia.org/wikipedia/commons/6/64/USA_I_in_heat_1_of_2_man_bobsleigh_at_2010_Winter_Olympics_2010-02-20.jpg)

class: center
.pull-center[

#Analysis: Temperature vs Medal Count
...
ggplot(all_olympics, aes(x = Avg_Temp, y = Total, xlim=(1000), fill = "blue"))  + xlab("Average Temperature(C))") + ylab("Total Number of Medals") +
  geom_point() +
...
>>>>>>> 714a82033744e80d83a580b5aae3ecf935720cba
  geom_point()
  theme_minimal()
