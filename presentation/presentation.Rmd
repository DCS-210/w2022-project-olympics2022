...
m <- leaflet() %>%
  ...
  addCircleMarkers(lng = 	174.89, lat = 40.90, color = 'green')%>%
...
ggplot(all_olympics, aes(x = (Num_Athletes/Population), y = Total, color = NOC, xlim=(1)))  + xlab("Winter Athletes per capita") + ylab("Total Medals") +
